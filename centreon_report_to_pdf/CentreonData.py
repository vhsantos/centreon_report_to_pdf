...
def get_centreon_csv_resume ():
    ...
    csv_resume = csv_resume.applymap(lambda s:s.capitalize() if type(s) == str else s)
...
def get_centreon_csv_details_HG ():
    ...
    # Define columns to be used
    COLUMN_DATA=['Hosts', 'Up %', 'Up Alert', 'Down %', 'Down Alert', 'Unreachable %', 'Unreachable Alert', 'Scheduled Downtimes %', 'Undetermined %']
